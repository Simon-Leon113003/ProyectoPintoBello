...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cliente>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdBarrios, "fk_Cliente_Barrios1");
            ...
            modelBuilder.Entity<DetalleFactura>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdFactura, "fk_Detalle_Factura_Factura1");

                entity.HasIndex(e => e.IdProducto, "fk_Detalle_Factura_Producto1");
            ...
            modelBuilder.Entity<Empleado>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdTipoEmpleado, "fk_Empleado_Tipo_Empleado");
            ...
            modelBuilder.Entity<Factura>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdCliente, "fk_Factura_Cliente1");

                entity.HasIndex(e => e.IdEmpleado, "fk_Factura_Empleado1");

                entity.HasIndex(e => e.IdFormasPago, "fk_Factura_Formas_Pago1");
            ...
            modelBuilder.Entity<Pedido>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdFactura, "fk_Pedido_Factura1");
            ...
            modelBuilder.Entity<Producto>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdMarca, "fk_Producto_Marca1");

                entity.HasIndex(e => e.IdProveedor, "fk_Producto_Proveedor1");

                entity.HasIndex(e => e.IdTipoProducto, "fk_Producto_Tipo_Producto1");
